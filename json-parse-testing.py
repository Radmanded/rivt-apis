...
for partner in partner['data']:
    partner_list.append(partner['partnerName'])
print(partner_list)

'''
partner = json.loads(json_data)

# Iterate through the list of partner and print the partner partnerNameBeGeoName and certification
for partner in partner['partner']:
    print(partner['partnerNameBeGeoName'], partner['certification'])
print(partner['partners'][0]['partnerNameBeGeoName'])
print(partner['partners'][1]['partnerNameBeGeoName'])
print(partner['partners'][0]['certification'])
print(partner['partners'][1]['certification'])
'''

#data_json["batters"]["batter"][0]["type"]

''' UNSURE HOW TO ACCESS NESTED ITEMS '''
# if len(partner_json["entity"]) == 1:
